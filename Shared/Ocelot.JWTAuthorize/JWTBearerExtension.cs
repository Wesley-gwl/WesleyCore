...
namespace Ocelot.JwtAuthorize
{
    ...
    public static class JwtBearerExtension
    {
        ...
        /// <returns></returns>
        public static AuthenticationBuilder AddApiJwtAuthorize(this IServiceCollection services, Func<HttpContext, bool> validatePermission, IConfiguration configuration)
        {
            if (configuration == null)
            {
                throw new OcelotJwtAuthorizeException("can't find JwtAuthorize section in appsetting.json");
