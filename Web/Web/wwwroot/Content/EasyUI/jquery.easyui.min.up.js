...
// cache:false => cache:opts.cache
$.ajax({type:opts.method,url:opts.href,cache:opts.cache,data:_26e,dataType:"html",success:function(data){
_26f(data);
},error:function(){
...
$.extend(_2b4, { width: _2b5.width, height: _2b5.height, left: _2b5.left < 0 ? 0 : _2b5.left, top: _2b5.top < 0 ? 0 : _2b5.top, closed: _2b5.closed, collapsed: _2b5.collapsed, minimized: _2b5.minimized, maximized: _2b5.maximized });
return _2b4;
},dialog:function(jq){
...
_503.attr("title", opts.prompt);//by 20180122
_503.unbind(".textbox");
...
if (opts.fixRownumber) {
    $(_713).datagrid('fixRownumber');
}
if (opts.cellTip) {
    $(_713).datagrid('cellTip');
}
};
function _71a(_71b){
...
if (_9fa) {
// 用于针对combogrid的 limittolist
if (_9f9.className.indexOf('combogrid-f') > 0) {
    var opts1 = $(_9f9).combogrid('options');
    if (opts1.limitToList) {
        var sr = $(_9f9).combogrid('grid').datagrid('getSelected');
        if (!sr || sr[opts1.idField] != $(_9f9).combogrid('getValue'))
            $(_9f9).combogrid('clear');
    }
}
...
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_a05,keydown:_a09,paste:_a09,drop:_a09},panelWidth:null,panelMinWidth:null,panelMaxWidth:null,panelHeight:null,panelMinHeight:null,panelMaxHeight:270,panelAlign:"left",reversed:false,multiple:false,multivalue:true,selectOnNavigation:true,separator:",",hasDownArrow:true,delay:200,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
var params = $(this).combogrid('options').queryParams;
params.q = $(this).combogrid('getText');
