...
using WesleyCore.Message;
using WesleyCore.Message.Application.IntegrationEvents.Message;
using WesleyCore.Message.Domain.Repository;
using WesleyCore.Message.Infrastructure.Repository;
...
namespace WesleyCore
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        {
            services.AddTransient(typeof(IPipelineBehavior<,>), typeof(MessageContextTransactionBehavior<,>));
        ...
        {
            return services.AddDbContext<MessageContext>(optionsAction);
        }
